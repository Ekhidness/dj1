...
def index(request):
    ...
    return render(
        request,
        'index.html',
        context={'num_books': num_books, 'num_instances': num_instances, 'search_word': search_word,
                 'num_instances_available': num_instances_available, 'num_authors': num_authors,
                 'num_visits': num_visits, 'num_genres': num_genres, 'num_books_with_word': num_books_with_word,},
    )
